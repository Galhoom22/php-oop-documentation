...
Start only after:
1. All 31 lectures in `01-PHP-OOP-Lectures.md` are completed.
2. All 31 interview questions in `02-PHP-OOP-Interview-Questions.md` are completed.
...
- [ ] The project runs from `03-Final-Project/playground.php` or the chosen manual runner.
...
- [ ] `03-Final-Project/notes.md` explains the main design decisions in interview style.
...
The mentor may show small code snippets in chat to explain an idea, but the student must type and save every project file in `03-Final-Project/` themselves.
...
The student will write project files inside `03-Final-Project/`.
...
- `03-Final-Project/README.md`
- `03-Final-Project/notes.md`
...
The student must write `03-Final-Project/notes.md` with answers to:
